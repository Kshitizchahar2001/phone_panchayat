...
class NativeAdmobOptions(
    ...
    val headlineTextStyle: NativeTextStyle = NativeTextStyle(14f, Color.BLACK),
    val advertiserTextStyle: NativeTextStyle = NativeTextStyle(10f, Color.BLACK),
    val bodyTextStyle: NativeTextStyle = NativeTextStyle(14f, Color.GRAY),
